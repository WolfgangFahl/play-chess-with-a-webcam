...
class ChessTrapezoidTest(TestCase):
    ...
    def test_ChessTrapezoid(self):
        ...
        testVideos=[
            ExampleVideo(1000,10000,1,[[427, 44], [1425, 52], [1406, 1023], [431, 1029]],270,
                ans=["e2","e4"]),
            ExampleVideo(334,334,testEnv.testMedia + 'scholarsmate.avi',[(140,5),(506,10),(507,377),(137,374)],270,
                ans=None), # ans=["e2","e4"]),
            ExampleVideo(75,503,testEnv.testMedia + 'scholarsMate2019-11-18.avi',[[0,0],[611,0], [611, 611], [0, 611]],0,
                ans=["e2","e4"]),
            ExampleVideo(300,5000,"/Users/wf/source/python/play-chess-with-a-webcam/media/chessVideo2019-10-17_185821.avi",[(210, 0), (603, 6), (581, 391), (208, 378)],rotation=270),
            ExampleVideo(240,240,"/Users/wf/Documents/pyworkspace/PlayChessWithAWebCam/scholarsMate2019-11-17.avi",[],270),
            ExampleVideo(165,438,tk+"TK_scholarsmate4.avi",[[147, 129], [405, 123], [418, 385], [148, 390]],0,
               ans=None), #["e2","e4","e7","e5"]),
            ExampleVideo(250,1392,tk+"TK_scholarsmate7.avi",[[0, 0], [404,0], [404,404], [0,404]],0,
               ans=None), #["e2","e4","e7","e5"]),
            ExampleVideo(62,91,videos+"chessgame_2019-11-19_203104.avi",[[0,0],[618,0], [618, 618], [0, 618]],0,
               ans=None), # ["e2","e4","e7","e5"])
            ExampleVideo(45,45,videos+"chessgame_2019-11-23_133629.avi",[[0,0],[607,0], [607, 607], [0, 607]],0,
               ans=None), # ["e2","e4"])
            ExampleVideo(244,244,videos+"chessgame_2019-11-26_145653.avi",[[0,0],[925,0], [925, 925], [0, 925]],0,
               ans=None), # ["e2","e4"])
            ExampleVideo(250,250,videos+"chessgame_2019-11-28_172745.avi",[[0,0],[983,0], [983, 983], [0, 983]],0,
               ans=None) # ["e2","e4"])
        ]
        # select a testVideo
        ...
        if debugChangeHistory:
            self.plotChangeHistory(changeHistory,testVideo,"square changes over time",detectState)
        if debugPlotHistory:
